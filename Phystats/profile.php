    ...
    <body>
        ...
        <nav>
            ...
            <div>
                ...
                <a class="here" href="profile.php"><img class="profile" src="assets/wprof.png"></a>
            </div>
        </nav>
            ...
            <form class="prof" method="POST">
                <div>
                    ...
                    <center>
                        ...
                        <input type="text" name="position" placeholder="Teaching Position" value="<?php echo $position ?>" required>
                        <div>
                            <label>Handling PE Grade:</label>
                            <select name='grade' required>
                                <option value="Four" <?php if (isset($grade) && $grade === "four") echo 'selected'; ?>>Four</option>
                                <option value="Five" <?php if (isset($grade) && $grade === "five") echo 'selected'; ?>>Five</option>
                                <option value="Six" <?php if (isset($grade) && $grade === "six") echo 'selected'; ?>>Six</option>
                            </select>
                        </div>
