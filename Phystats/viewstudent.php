                        ...
                        <div class="print-container">
                            <div class="section-1">
                                    ...
                                    <tr>
                                        ...
                                        <th><label for="BMI">BMI</label><br><input type="number" name="BMI"
                                            ...
                                            <label for="bmiClassification">BMI CLASSIFICATION</label><br><input type="text"
                                                name="bmiClassification" value="<?php echo $datarow['bmiClassification']; ?>"
                                                readonly>
                                        </th>
                                        ...
                                        <th><label for="HRafter">After Activity</label><br><input type="number" name="HRafter"
                                                value="<?php echo $datarow['HRafter']; ?>" step="0.01" min="40" max="220" readonly>
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <th><br><input type="number" name="juggling" value="<?php echo $datarow['juggling']; ?>"
                                                min="0" readonly></th>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th><label for="hexcounter">Counter Clockwise</label><br><input type="number"
                                                name="hexcounter" value="<?php echo $datarow['hexagonCounter']; ?>" min="0"
                                                readonly></th>
                                    ...
                                    <tr>
                                        <th><label for="stick1">First Trial</label><br><input type="number" name="stick1"
                                                value="<?php echo $datarow['stickDrop1']; ?>" step="0.01" min="0" max="30.48"
                                                readonly>
                                        </th>
                                        <th><label for="stick2">Second Trial</label><br><input type="number" name="stick2"
                                                value="<?php echo $datarow['stickDrop2']; ?>" step="0.01" min="0" max="30.48"
                                                readonly>
                                        </th>
                                        <th><label for="stick3">Third Trial</label><br><input type="number" name="stick3"
                                                value="<?php echo $datarow['stickDrop3']; ?>" step="0.01" min="0" max="30.48"
                                                readonly>
                                        </th>
                                    </tr>
                                </table>
