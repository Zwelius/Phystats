                    ...
                    while ($datarow = mysqli_fetch_array($thisdata)) {
                        ...
                        <div class="section1">
                            ...
                            <table class="add-students-table">
                                ...
                                <tr>
                                    <th><label for="height">HEIGHT (m):</label><br><input type="number" name="height"
                                            value="<?php echo $datarow['height']; ?>" min="0" step="0.01" readonly><br>
                                        <label for="weight">WEIGHT (kg):</label><br><input type="number" name="weight"
                                            value="<?php echo $datarow['weight']; ?>" min="0" step="0.01" readonly>
                                    </th>
                                    <th><label for="BMI">BMI</label><br><input type="number" name="BMI"
                                            value="<?php echo $datarow['BMI']; ?>" min="0" step="0.01" readonly><br>
                                        <label for="bmiClassification">BMI CLASSIFICATION</label><br><input type="text"
                                            name="bmiClassification" value="<?php echo $datarow['bmiClassification']; ?>" readonly>
                                    </th>
                                    <th><label for="HRbefore">Before Activity</label><br><input type="number" name="HRbefore"
                                            value="<?php echo $datarow['HRbefore']; ?>" step="0.01" min="40" max="220" readonly>
                                    </th>
                                    <th><label for="HRafter">After Activity</label><br><input type="number" name="HRafter"
                                            value="<?php echo $datarow['HRafter']; ?>" step="0.01" min="40" max="220" readonly></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th><label for="zipperL">Left</label><br> <input type="number" name="zipperL"
                                            value="<?php echo $datarow['zipperLeft']; ?>" step="0.01" readonly></th>
                                    <th><label for="zipperR">Right</label><br><input type="number" name="zipperR"
                                            value="<?php echo $datarow['zipperRight']; ?>" step="0.01" readonly></th>
                                    <th><label for="sar1">First Trial</label><br><input type="number" name="sar1"
                                            value="<?php echo $datarow['sitReach1']; ?>" step="0.01" min="0" readonly></th>
                                    <th><label for="sar2">Second Trial</label><br><input type="number" name="sar2"
                                            value="<?php echo $datarow['sitReach2']; ?>" step="0.01" min="0" readonly></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th><label for="pushups">NO. OF PUSH UPS</label><br> <input type="number" name="pushups"
                                            value="<?php echo $datarow['pushupsNo']; ?>" min="0" readonly></th>
                            ...
                            <table class="add-students-table">
                                ...
                                <tr>
                                    <th><br><input type="number" name="juggling" value="<?php echo $datarow['juggling']; ?>" min="0"
                                            readonly></th>
                                    <th><br><input type="number" name="sprinttime" value="<?php echo $datarow['sprintTime']; ?>"
                                            min="0" step="0.01" readonly></th>
                                    <th><label for="slj1">First Trial</label><br>
                                        <input type="number" name="slj1" value="<?php echo $datarow['longJump1']; ?>" min="0"
                                            step="0.01" readonly>
                                    </th>
                                    <th><label for="slj2">Second Trial</label><br>
                                        <input type="number" name="slj2" value="<?php echo $datarow['longJump2']; ?>" min="0"
                                            step="0.01" readonly>
                                    </th>
                                </tr>
                                ...
                                <tr>
                                    <th><label for="clockwise">Clockwise</label><br><input type="number" name="hexclock"
                                            value="<?php echo $datarow['hexagonClockwise']; ?>" min="0" readonly></th>
                                    <th><label for="hexcounter">Counter Clockwise</label><br><input type="number" name="hexcounter"
                                            value="<?php echo $datarow['hexagonCounter']; ?>" min="0" readonly></th>
                                    <th><label for="storkleft">Left Foot</label><br><input type="number" name="storkleft"
                                            value="<?php echo $datarow['storkLeft']; ?>" min="0" readonly>
                                    </th>
                                    <th><label for="storkright">Right Foot</label><br><input type="number" name="storkright"
                                            value="<?php echo $datarow['storkRight']; ?>" min="0" readonly>
                                    </th>
                                </tr>
                                <tr>
                                    <th colspan="4">&nbsp;</th><!--empty-->
                                ...
                                <tr>
                                    <th><label for="stick1">First Trial</label><br><input type="number" name="stick1"
                                            value="<?php echo $datarow['stickDrop1']; ?>" step="0.01" min="0" max="30.48" readonly>
                                    </th>
                                    <th><label for="stick2">Second Trial</label><br><input type="number" name="stick2"
                                            value="<?php echo $datarow['stickDrop2']; ?>" step="0.01" min="0" max="30.48" readonly>
                                    </th>
                                    <th><label for="stick3">Third Trial</label><br><input type="number" name="stick3"
                                            value="<?php echo $datarow['stickDrop3']; ?>" step="0.01" min="0" max="30.48" readonly>
                                    </th>
                                </tr>
                            </table>
                        </div>
